...
**NOTE: Continue with the next steps only if you have an S/4 System. You can Skip to [Exercise 4 - Add Business Partner Service & Connect your application to the Sandbox](../ex4/ex4.1/README.md) to add the mock Business Partner Data**
