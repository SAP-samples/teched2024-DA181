...
```
Create a risk management app with risks and mitigation. Each risk refers to a mitigation. Add realistic properties to each entity, risks should include a property impact and criticality which should be an integer. Impacts should be in range of 1 to 20000 dollars. Migrations should include a counter
```
